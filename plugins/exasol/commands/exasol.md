...
1. **Classify the task before checking connections.**
   ...
   - Transformers Extension workflows such as `initialize_te_extension`, `deploy_scripts`, `TE UDF`, or Hugging Face model setup in Exasol -> use **exasol-transformers** behavior.
