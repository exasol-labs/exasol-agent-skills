...
It does not populate these higher-level setup keys:
...
If you want the store to pass the shared setup validation flow afterward, add
the missing setup keys explicitly:
