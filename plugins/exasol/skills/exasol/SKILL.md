...
1. **Exasol database, query, exapump, and export workflows**
   - Trigger phrases: `query`, `Exasol SQL`, `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `MERGE`, `CREATE TABLE`, `ALTER TABLE`, `DROP TABLE`, `EXPORT`, `profile`, `exapump`, `exapump sql`, `exapump export`, `exapump profile`
...
10. **UDFs and Script Language Containers**
