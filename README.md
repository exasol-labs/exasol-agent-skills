...
6. Keep Markdown links valid so the CI link checker passes; use `python3 test/check-links.py --skip-external` for the CI-equivalent local check and `python3 test/check-links.py` before review when changing external links.
