...
- `plugins/exasol/commands/exasol.md` — thin Claude-only `/exasol` entry point that delegates all classification and safety rules to the top-level router skill
...
2. **test-installer** — all 8 Docker scenarios
